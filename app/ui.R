                            ...
                            sidebarPanel(
                              ...
                              selectInput(
                                ...
                                choices = c("fractional_brownian_motion_05",
                                            ...
                                            "fractional_brownian_motion_50",
                                            "fractional_brownian_motion_60",
                                            "fractional_brownian_motion_70",
                                            "fractional_brownian_motion_80",
                                            "fractional_brownian_motion_90",
                                            "fractional_brownian_motion_100",
